...
{!! Form::open(['id' => 'post-form', 'action' => 'PostsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    ...
    <div class="form-group {{ $errors->has('area') ? 'has-error' : '' }}">
        ...
        <div>
            {{Form::number('area', '', ['min' => 10, 'required' => 'required'])}} ft<sup>2</sup>
        </div>
        @if($errors->has('area'))
            <span class="help-block">
    ...
    <div class="form-group {{ $errors->has('bedrooms') ? 'has-error' : '' }}">
        ...
        <div>
            {{Form::number('bedrooms', '', ['min' => 1, 'required' => 'required'])}}
        </div>
    ...
    <div class="form-group {{ $errors->has('bathrooms') ? 'has-error' : '' }}">
        ...
        <div>
            {{Form::number('bathrooms', '', ['min' => 1, 'required' => 'required'])}}
        </div>
    ...
    <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
        ...
        <div>
            $ {{Form::number('price', '', ['min' => 1, 'required' => 'required'])}}
        </div>
        @if($errors->has('price'))
            <span class="help-block">
